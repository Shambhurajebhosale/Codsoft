...
public class guess_no_game {
	public static void main(String args[]) {
		...
		while (playAgain) {
			...
			System.out.println(" I have Selected The Number Between " + minRange + " and " + maxRange
					+ " Try the another number ");
			int attempts = 0;
			while (attempts < maxattempt) {
				...
				if (userGuess < targetNumber) {
					...
					System.out.println(
							" Congratulations..! You Guessed The Correct Number" + targetNumber + " in " + attempts);
